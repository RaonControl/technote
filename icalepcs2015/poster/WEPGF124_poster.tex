...
\item Synchronized signal of EVG is generated and distributed to EVR according to event code of MRFIOC on VME system
\end{itemize}
\end{mdframed}
...
\subsection*{Fast Stepper Motor Testbed using Timing Signal}
\begin{mdframed}[roundcorner=10pt]
	\begin{figure}[H]
		\centering
