...
그림\ref{controller}는 motor를 구동하기 위한 Analog Devices사의 controller 및 low voltage drive board를 보여준다.

\begin{figure}[!htb]
	\centering
	\includegraphics*[width=75mm, height=55mm]{controller}
	\caption{Controller and Low Voltage Board}
	\label{controller}
\end{figure}

%https://wiki.analog.com/resources/eval/user-guides/ad-fmcmotcon2-ebz/hardware/lv_board
%https://wiki.analog.com/resources/eval/user-guides/ad-fmcmotcon2-ebz/hardware/controller_board
